...
public class RobotWorld {
    ...
    public void rotateClockwise() {
        ...
        if(worldMap[robotRow][robotColumn] == NORTH) worldMap[robotRow][robotColumn] = EAST;
        else if (worldMap[robotRow][robotColumn] == EAST) worldMap[robotRow][robotColumn] = SOUTH;
        else if (worldMap[robotRow][robotColumn] == SOUTH) worldMap[robotRow][robotColumn] = WEST;
        else if(worldMap[robotRow][robotColumn] == WEST) worldMap[robotRow][robotColumn] = NORTH;
    }
    ...
    public void rotateCounterClockwise() {
        ...
        if(worldMap[robotRow][robotColumn] == NORTH) worldMap[robotRow][robotColumn] = WEST;
        else if(worldMap[robotRow][robotColumn] == WEST) worldMap[robotRow][robotColumn] = SOUTH;
        else if(worldMap[robotRow][robotColumn] == SOUTH) worldMap[robotRow][robotColumn] = EAST;
        else if (worldMap[robotRow][robotColumn] == EAST) worldMap[robotRow][robotColumn] = NORTH;
    ...
    public void moveForward() throws Exception {
        ...
        System.out.print("R:W = " + robotRow+":"+robotColumn);
        if(worldMap[robotRow][robotColumn] == NORTH) {
            worldMap[robotRow][robotColumn] = SPACE;
            robotRow -= 1;
            System.out.println("->" + robotRow+":"+robotColumn);
